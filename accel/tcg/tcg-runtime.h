...
DEF_HELPER_FLAGS_1(cgi_hook_strcmp_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_strncmp_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_strcasecmp_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_strncasecmp_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_strstr_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_strtok_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_2(cgi_hook_func_ret, TCG_CALL_NO_RWG, void, env, tl)
DEF_HELPER_FLAGS_1(cgi_hook_qcgisess_oem_init_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_qentry_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_qentry_getint_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_qentry_getstr_arg, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_1(cgi_hook_free_arg, TCG_CALL_NO_RWG, void, env)
